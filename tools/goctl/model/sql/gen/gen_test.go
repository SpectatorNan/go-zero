...
func TestCacheModel(t *testing.T) {
	...
	err = g.StartFromDDL(sqlFile, true, false, "go_zero", true, "deleted_at")
	assert.Nil(t, err)
	...
	err = g.StartFromDDL(sqlFile, false, false, "go_zero", false, "deleted_at")
	assert.Nil(t, err)
	assert.True(t, func() bool {
...
func TestNamingModel(t *testing.T) {
	...
	err = g.StartFromDDL(sqlFile, true, false, "go_zero", false, "deleted_at")
	assert.Nil(t, err)
	assert.True(t, func() bool {
...
func TestFolderName(t *testing.T) {
	...
	err = g.StartFromDDL(sqlFile, true, true, "go_zero", false, "deleted_at")
	assert.Nil(t, err)
	assert.True(t, func() bool {
		_, err := os.Stat(filepath.Join(camelDir, "TestUserModel.go"))
		return err == nil
